...
Our approach to comprove the hypothesis is the exploration of rate of speech, pause behavior, proportion of filled pauses and lexical diversity. These variables are combined and we apply a dimensionality reduction technique, t-sne, to visualize their separability in a 2d plane. If the variable combination have some information to separate the groups, the t-sne would plot valid cluster like structures.
